...
<svg
	...
	/><path
		...
		fill="#5C5F62"
	/><path d="M7.25 12.5a.75.75 0 0 0 0 1.5h5.5a.75.75 0 0 0 0-1.5h-5.5Z" fill="#5C5F62" /><path
		fill-rule="evenodd"
		...
		fill="#5C5F62"
	/><path d="M16.5 8.25a.75.75 0 0 0 0-1.5h-1.25a.75.75 0 0 0 0 1.5h1.25Z" fill="#5C5F62" /></svg
>
