...
<script lang="ts">
	...
	let {
		size = 'md',
		role = 'img',
		ariaLabel = 'collection reference',
		class: klass,
		...rest
	}: App.IconProps = $props();
</script>
