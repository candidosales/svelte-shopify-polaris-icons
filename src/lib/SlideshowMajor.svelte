...
<svg
	...
	viewBox="0 0 20 20"
	><path d="M13.5 7a1.25 1.25 0 1 1-2.5 0 1.25 1.25 0 0 1 2.5 0Z" fill="#5C5F62" /><path
		fill-rule="evenodd"
		...
		fill="#5C5F62"
	/><path d="M6 17a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z" fill="#5C5F62" /><path
		d="M11 16a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"
		fill="#5C5F62"
	/><path d="M14 17a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z" fill="#5C5F62" /></svg
>
