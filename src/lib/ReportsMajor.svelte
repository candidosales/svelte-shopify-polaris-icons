...
<svg
	...
	viewBox="0 0 20 20"
	><path d="M8.5 12.25a.75.75 0 0 0-1.5 0v2a.75.75 0 0 0 1.5 0v-2Z" fill="#5C5F62" /><path
		d="M12.25 11.5a.75.75 0 0 1 .75.75v2a.75.75 0 0 1-1.5 0v-2a.75.75 0 0 1 .75-.75Z"
		fill="#5C5F62"
	/><path d="M10.75 14.25v-3.5a.75.75 0 0 0-1.5 0v3.5a.75.75 0 0 0 1.5 0Z" fill="#5C5F62" /><path
		fill-rule="evenodd"
