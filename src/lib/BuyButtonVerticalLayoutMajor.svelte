...
<svg
	...
	/><path
		...
		fill="#5C5F62"
	/><path d="M3.5 11a.75.75 0 0 0 1.5 0v-2a.75.75 0 0 0-1.5 0v2Z" fill="#5C5F62" /><path
		fill-rule="evenodd"
		...
		fill="#5C5F62"
	/><path d="M7.75 13a.75.75 0 0 0 0 1.5h4.5a.75.75 0 0 0 0-1.5h-4.5Z" fill="#5C5F62" /></svg
>
