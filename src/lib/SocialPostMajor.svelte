...
<svg
	...
	/><path
		...
		fill="#5C5F62"
	/><path d="M6.75 7.25a.75.75 0 0 0 0 1.5h5.5a.75.75 0 0 0 0-1.5h-5.5Z" fill="#5C5F62" /><path
		d="M6 10.25a.75.75 0 0 1 .75-.75h3.5a.75.75 0 0 1 0 1.5h-3.5a.75.75 0 0 1-.75-.75Z"
		fill="#5C5F62"
	/><path d="M18.25 7.75a.75.75 0 0 0 0-1.5h-1.25a.75.75 0 0 0 0 1.5h1.25Z" fill="#5C5F62" /></svg
>
