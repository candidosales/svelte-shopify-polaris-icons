...
<script lang="ts">
	...
	let {
		size = 'md',
		role = 'img',
		ariaLabel = 'fraud protect unprotected',
		class: klass,
		...rest
	}: App.IconProps = $props();
</script>
