...
<svg
	...
	viewBox="0 0 20 20"
	><path d="M5.5 4.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z" fill="#5C5F62" /><path
		fill-rule="evenodd"
		...
		fill="#5C5F62"
	/><path d="M4.5 9a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z" fill="#5C5F62" /><path
		d="M5.5 11.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"
		fill="#5C5F62"
	/><path d="M6.75 3.75a.75.75 0 0 0 0 1.5h6.5a.75.75 0 0 0 0-1.5h-6.5Z" fill="#5C5F62" /></svg
>
