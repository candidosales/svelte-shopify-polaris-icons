...
<svg
	...
	/><path
		...
		fill="#5C5F62"
	/><path d="M3.75 14.5a.75.75 0 0 0 0 1.5h2.625a.75.75 0 0 0 0-1.5h-2.625Z" fill="#5C5F62" /><path
		d="M11 14.5a.75.75 0 0 0 0 1.5h2.625a.75.75 0 0 0 0-1.5h-2.625Z"
		fill="#5C5F62"
	/><path d="M11 11.75a.75.75 0 0 0 0 1.5h5.25a.75.75 0 0 0 0-1.5h-5.25Z" fill="#5C5F62" /><path
		fill-rule="evenodd"
