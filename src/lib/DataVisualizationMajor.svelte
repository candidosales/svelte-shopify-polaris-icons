...
<svg
	...
	viewBox="0 0 20 20"
	><path d="M13.5 6.75a.75.75 0 0 0-1.5 0v3.5a.75.75 0 0 0 1.5 0v-3.5Z" fill="#5C5F62" /><path
		d="M7.25 8.5a.75.75 0 0 1 .75.75v1a.75.75 0 0 1-1.5 0v-1a.75.75 0 0 1 .75-.75Z"
		fill="#5C5F62"
	/><path d="M10.75 8a.75.75 0 0 0-1.5 0v2.25a.75.75 0 0 0 1.5 0v-2.25Z" fill="#5C5F62" /><path
		fill-rule="evenodd"
