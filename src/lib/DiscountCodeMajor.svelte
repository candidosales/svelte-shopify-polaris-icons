...
<svg
	...
	/><path
		...
		fill="#5C5F62"
	/><path d="M9 8a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z" fill="#5C5F62" /><path
	...
	/><path
		...
		fill="#5C5F62"
	/><path d="M11 16.75a.75.75 0 0 0 0-1.5h-2a.75.75 0 0 0 0 1.5h2Z" fill="#5C5F62" /><path
		d="M4 8.25a.75.75 0 0 1 .75.75v2a.75.75 0 0 1-1.5 0v-2a.75.75 0 0 1 .75-.75Z"
		fill="#5C5F62"
	/><path d="M11 4.75a.75.75 0 0 0 0-1.5h-2a.75.75 0 0 0 0 1.5h2Z" fill="#5C5F62" /></svg
>
